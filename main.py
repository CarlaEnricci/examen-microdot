...
def index(request):
    ...
    """
    return send_file("/aguja/assets/index.html")
...
def assets(request, dir, file):
    ...
    """
    return send_file("/aguja/assets/" + dir + "/" + file)
...
def data_update(request):
    ...
    lectura = ldr.read()
    ldr_float = ((4095 - lectura) / 4095) * 100
    ldr_int = int (ldr_float)
    # Retorno el diccionario
    return { "porcentaje_luminico" : ldr_int }
